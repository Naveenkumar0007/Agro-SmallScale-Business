...
<html lang="en">
	<head>
		<meta charset="UTF-8">
		<title>Agro SmallScale Business</title>
	...
	?>
		...
		<!-- Banner -->
			<section id="banner" class="wrapper">
				<div class="container">
				<h2>Agro SmallScale Business</h2>
		...
		<div class="footer-left">
			<h3 style="font-family: 'Times New Roman', cursive;">Agro SmallScale Business &copy; </h3>
		<!--	<div class="logo">
		...
		<div class="footer-center">
			<div>
				...
				<p style="font-size:20px">Agro Fam<span>Vormir</span></p>
			</div>
			<div>
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:Agro SmallScale Business@gmail.com" style="color:white">demo@demo.com</a></p>
			</div>
		</div>

		<div class="footer-right">
			<p class="footer-company-about" style="color:white">
				<span style="font-size:20px"><b>About Agro SmallScale Business</b></span>
				Agro SmallScale Business is e-commerce trading platform for grains & grocerries...
			</p>
